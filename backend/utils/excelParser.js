...
const COLUMN_PATTERNS = {
    ...
    guideName: /name.*of.*the.*guide|guide.*name|name.*of.*guide|mentor|supervisor|faculty|advisor/i,
    projectTitle: /project.*title|title/i,
    researchArea: /research.*thrust|thrust.*area|research.*area|domain/i,
